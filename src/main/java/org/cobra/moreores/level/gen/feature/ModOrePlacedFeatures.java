...
public class ModOrePlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> placedFeatureRegisterable) {
        HolderGetter<Feature> placedFeatureRegisterableRegistryLookup = placedFeatureRegisterable.lookup(Registries.FEATURE);
        Holder<Feature> registryEntry20 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_RUBY_SMALL);
        Holder<Feature> registryEntry21 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_RUBY_MEDIUM);
        Holder<Feature> registryEntry22 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_RUBY_LARGE);
        Holder<Feature> registryEntry23 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_SAPPHIRE_SMALL);
        Holder<Feature> registryEntry24 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_SAPPHIRE_MEDIUM);
        Holder<Feature> registryEntry25 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_SAPPHIRE_LARGE);
        Holder<Feature> registryEntry26 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_GREEN_SAPPHIRE_SMALL);
        Holder<Feature> registryEntry27 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_GREEN_SAPPHIRE_MEDIUM);
        Holder<Feature> registryEntry28 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_GREEN_SAPPHIRE_LARGE);
        Holder<Feature> registryEntry29 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_BLUE_GARNET_SMALL);
        Holder<Feature> registryEntry30 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_BLUE_GARNET_MEDIUM);
        Holder<Feature> registryEntry31 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_BLUE_GARNET_LARGE);
        Holder<Feature> registryEntry32 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PINK_GARNET_SMALL);
        Holder<Feature> registryEntry33 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PINK_GARNET_MEDIUM);
        Holder<Feature> registryEntry34 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PINK_GARNET_LARGE);
        Holder<Feature> registryEntry35 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_GREEN_GARNET_SMALL);
        Holder<Feature> registryEntry36 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_GREEN_GARNET_MEDIUM);
        Holder<Feature> registryEntry37 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_GREEN_GARNET_LARGE);
        Holder<Feature> registryEntryX = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_KYAWTHUITE);
        Holder<Feature> registryEntry38 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_TOPAZ_SMALL);
        Holder<Feature> registryEntry39 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_TOPAZ_MEDIUM);
        Holder<Feature> registryEntry40 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_TOPAZ_LARGE);
        Holder<Feature> registryEntry41 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_WHITE_TOPAZ_SMALL);
        Holder<Feature> registryEntry42 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_WHITE_TOPAZ_MEDIUM);
        Holder<Feature> registryEntry43 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_WHITE_TOPAZ_LARGE);
        Holder<Feature> registryEntry44 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PERIDOT_SMALL);
        Holder<Feature> registryEntry45 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PERIDOT_LARGE);
        Holder<Feature> registryEntry46 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PERIDOT_MEDIUM);
        Holder<Feature> registryEntry47 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_JADE_SMALL);
        Holder<Feature> registryEntry48 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_JADE_LARGE);
        Holder<Feature> registryEntry49 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_JADE_MEDIUM);
        Holder<Feature> registryEntry50 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PYROPE_SMALL);
        Holder<Feature> registryEntry51 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PYROPE_LARGE);
        Holder<Feature> registryEntry52 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_PYROPE_MEDIUM);
        Holder<Feature> registryEntry53 = placedFeatureRegisterableRegistryLookup.getOrThrow(ModOreFeatures.ORE_ECLIPSE_GEM);
