...
public class GemPurifierScreen extends AbstractGemMachineScreen<GemPurifierBlockEntity, GemPurifierMenu> {
    ...
    public void init() {
        ...
        addRenderableOnly(FluidWidget.creator(menu.getBlockEntity().fluidStorage).bounds(this.leftPos + 10, this.topPos + 42, 20, 44).posSupplier(menu.getBlockEntity()::getBlockPos).create());
    }
