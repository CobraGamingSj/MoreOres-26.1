...
public enum PurifyingGems implements IGem, StringRepresentable {
    ...
    public static final Codec<PurifyingGems> CODEC = StringRepresentable.fromEnum(PurifyingGems::values);
