...
public class ModTrimMaterials {
    ...
    public static void bootstrap(BootstrapContext<TrimMaterial> context) {
        register(context, RUBY, Style.EMPTY.withColor(16711680), ModMaterialAssetGroup.RUBY);
        register(context, RADIANT, Style.EMPTY.withColor(11730944), ModMaterialAssetGroup.RADIANT);
        register(context, SAPPHIRE, Style.EMPTY.withColor(6875), ModMaterialAssetGroup.SAPPHIRE);
        register(context, GREEN_SAPPHIRE, Style.EMPTY.withColor(2925312), ModMaterialAssetGroup.GREEN_SAPPHIRE);
        register(context, BLUE_GARNET, Style.EMPTY.withColor(TextColor.fromRgb(1507522)), ModMaterialAssetGroup.BLUE_GARNET);
        register(context, PINK_GARNET, Style.EMPTY.withColor(16711927), ModMaterialAssetGroup.PINK_GARNET);
        register(context, GREEN_GARNET, Style.EMPTY.withColor(65331), ModMaterialAssetGroup.GREEN_GARNET);
        register(context, KYAWTHUITE, Style.EMPTY.withColor(16737792), ModMaterialAssetGroup.KYAWTHUITE);
        register(context, TOPAZ, Style.EMPTY.withColor(13713152), ModMaterialAssetGroup.TOPAZ);
        register(context, WHITE_TOPAZ, Style.EMPTY.withColor(15328482), ModMaterialAssetGroup.WHITE_TOPAZ);
        register(context, PERIDOT, Style.EMPTY.withColor(52238), ModMaterialAssetGroup.PERIDOT);
        register(context, JADE, Style.EMPTY.withColor(11140783), ModMaterialAssetGroup.JADE);
        register(context, PYROPE, Style.EMPTY.withColor(12717839), ModMaterialAssetGroup.PYROPE);

        register(context, CRIMSON_GARNET, Style.EMPTY.withColor(12058624), ModMaterialAssetGroup.CRIMSON_GARNET);
        register(context, CRYSTALLITE, Style.EMPTY.withColor(2086544), ModMaterialAssetGroup.CRYSTALLITE);
        register(context, RADIANT_AMETHYST, Style.EMPTY.withColor(8733893), ModMaterialAssetGroup.RADIANT_AMETHYST);
        register(context, LIMESTONE, Style.EMPTY.withColor(65459), ModMaterialAssetGroup.LIMESTONE);
        register(context, MOONSTONE, Style.EMPTY.withColor(14935011), ModMaterialAssetGroup.MOONSTONE);
        register(context, ALEXANDRITE, Style.EMPTY.withColor(12009953), ModMaterialAssetGroup.ALEXANDRITE);
        register(context, QUARTSIDIAN, Style.EMPTY.withColor(5197647), ModMaterialAssetGroup.QUARTSIDIAN);
        register(context, OPAL, Style.EMPTY.withColor(5085951), ModMaterialAssetGroup.OPAL);
        register(context, RED_BERYL, Style.EMPTY.withColor(15073280), ModMaterialAssetGroup.RED_BERYL);
    }
