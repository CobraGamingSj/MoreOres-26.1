...
public class MOREIClient implements REIClientPlugin {
    ...
    public void registerScreens(ScreenRegistry registry) {
        registry.registerClickArea(screen -> new Rectangle(((screen.width - 226) / 2) - 30, ((screen.height - 201) / 2), 25, 20),
                GemPurifierScreen.class, MOREICommon.GEM_PURIFIER);
        registry.registerClickArea(screen -> new Rectangle(((screen.width - 201) / 2) - 30, ((screen.height - 196) / 2), 25, 20),
